...
namespace MultipleSpouses
{
    internal class FurniturePatches
	{
		...
		public static bool BedFurniture_draw_Prefix(BedFurniture __instance, SpriteBatch spriteBatch, float alpha, NetVector2 ___drawPosition)
        {
			if (!Config.EnableMod || !Config.CustomBed || __instance.isTemporarilyInvisible || !Furniture.isDrawingLocationFurniture || __instance.bedType != BedFurniture.BedType.Double)
				return true;
