...
namespace CropVariation
{
    public partial class ModEntry
    {
        ...
        {
            if (!Config.EnableMod || Config.SizeVariationPercent == 0 || !Game1.currentLocation.terrainFeatures.TryGetValue(tileLocation, out TerrainFeature f) || (f as HoeDirt).crop.currentPhase.Value == 0)
                return 4;
