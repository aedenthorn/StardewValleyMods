...
namespace StatueShorts
{
	public partial class ModEntry
	{
		...
		public class Object_DayUpdate_Patch
		{
			...
			{
				if (!Config.ModEnabled || __instance.isTemporarilyInvisible || !__instance.bigCraftable.Value || __instance.Name != "Solid Gold Lewis" || !__instance.modData.TryGetValue(modKey, out var which) || __instance.Location is not Town)
					return true;
				...
				{
					if (Game1.getLocationFromName("ManorHouse").CanItemBePlacedHere(new Vector2(22, 6)))
					{
				...
				else if (Game1.getLocationFromName("AnimalShop").CanItemBePlacedHere(new Vector2(11, 6)))
				{
					if (!Game1.player.hasOrWillReceiveMail("lewisStatue"))
					{
						Game1.mailbox.Add("lewisStatue");
		...
		public class Object_performRemoveAction_Patch
		{
			public static void Prefix(Object __instance)
			{
				...
				Game1.createObjectDebris(which == "trimmed" ? "71" : "789", (int)__instance.TileLocation.X, (int)__instance.TileLocation.Y, __instance.Location);
			}
		}
	}
}
