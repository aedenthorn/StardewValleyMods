...
namespace AdvancedCooking
{
    ...
    public partial class ModEntry
    {
        ...
        private static int yOffset = 532;
        ...
        private static void CraftingPage_Prefix(CraftingPage __instance, int x, int y, bool cooking, List<Chest> material_containers, ref int height)
        {
            ...
            if (cooking)
            {
                ...
                ingredientMenu = new InventoryMenu(x + IClickableMenu.spaceToClearSideBorder + IClickableMenu.borderWidth, y + IClickableMenu.spaceToClearTopBorder + IClickableMenu.borderWidth + yOffset + 84, false, ingredients, null, 11, 1, 0, 0, true);
                isCookingMenu = true;
                cookButton = new ClickableTextureComponent(new Rectangle(x + IClickableMenu.spaceToClearSideBorder + IClickableMenu.borderWidth + 64 * 11, y + IClickableMenu.spaceToClearTopBorder + IClickableMenu.borderWidth + yOffset + 80, 64, 64), Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 46, -1, -1), 1f, false)
                {
                    myID = 102,
        ...
        private static void Game1_drawDialogueBox_Postfix()
        {
            ...
            int yStart = Game1.activeClickableMenu.yPositionOnScreen + IClickableMenu.borderWidth + IClickableMenu.spaceToClearTopBorder + yOffset;
