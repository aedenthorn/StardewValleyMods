...
namespace PaintingDisplay
{
    ...
    public partial class ModEntry
    {
        ...
        {
            if (!Config.EnableMod || __instance.displayItem.Value == null || !(__instance.displayItem.Value is Furniture) || (__instance.displayItem.Value as Furniture).furniture_type.Value != 6)
                return true;
