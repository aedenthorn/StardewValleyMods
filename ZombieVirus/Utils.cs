...
namespace ZombieVirus
{
    internal class Utils
    {
        ...
        internal static void MakeZombiePlayer(long z)
        {
            ...
            Texture2D texture = f.Sprite.Texture;
        ...
        internal static void MakeZombieSpeak(ref string dialogue)
        {
        ...
        private static void AddZombie(string name)
        {
        ...
        internal static void RemoveZombie(string name)
        {
            List<string> zombies = helper.Data.ReadSaveData<List<string>>("zombies") ?? new List<string>();
            zombies.Remove(name);
            helper.Data.WriteSaveData("zombies", zombies);
        ...
        private static void AddZombiePlayer(long id)
        {
        ...
        internal static void RemoveZombiePlayer(long id)
        {
            List<long> zombiePlayers = helper.Data.ReadSaveData<List<long>>("zombiePlayers") ?? new List<long>();
